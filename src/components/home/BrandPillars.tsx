        ...
        {PILLARS.map((pillar) => (
          ...
          >
            <motion.div 
              ...
              className={`${pillar.color} rounded-[2rem] md:rounded-[3rem] p-10 md:p-20 flex flex-col justify-between aspect-[4/5] md:aspect-[5/4] transition-all duration-700 hover:shadow-2xl hover:shadow-black/5`}
            >
              {/* Pillar Header */}
              <div className="flex justify-between items-start">
                 <span className="font-mona text-[10px] font-black text-black/20 tracking-widest">{pillar.id}</span>
                 <div className="w-12 h-12 rounded-full border border-black/5 flex items-center justify-center text-black opacity-0 group-hover:opacity-100 -translate-y-4 group-hover:translate-y-0 transition-all duration-500">
              ...
              <div className="space-y-6 md:space-y-10">
                ...
                <p className="font-poppins text-base md:text-xl text-black/40 max-w-sm leading-relaxed font-light">
                   {pillar.description}
                </p>
