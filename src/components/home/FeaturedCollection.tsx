...
const FeaturedCollection = ({ featuredProducts, onQuickView }: FeaturedCollectionProps) => {
  ...
  return (
    <section className="py-12 md:py-32 bg-[#ede9e1]">
      <div className="max-w-[1200px] mx-auto px-4 md:px-12">
        
        {/* Bento Grid Layout - Responsive 7:5 Split for ALL devices */}
        <div className="grid grid-cols-12 gap-3 md:gap-6 items-stretch mb-12">
          ...
          >
            <div className="h-full bg-white/40 rounded-[1.5rem] md:rounded-[4rem] overflow-hidden border border-black/[0.03] shadow-sm transition-all duration-700">
               ...
               <div className="absolute inset-x-0 bottom-6 md:bottom-10 px-4 md:px-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        ...
        {/* Product Details - Master Info */}
        <div className="text-center space-y-3 md:space-y-4">
           <h3 className="font-serif text-3xl md:text-6xl font-medium italic text-black tracking-tight leading-none px-4">
              {mainProduct.name}
           </h3>
           <p className="font-mona text-[9px] md:text-[11px] font-black tracking-[0.4em] uppercase text-black/40 px-4">
              {mainProduct.description.split('.')[0]}
           </p>
           <div className="pt-4 md:pt-6">
              <span className="font-mona text-xl md:text-2xl font-black text-black">
