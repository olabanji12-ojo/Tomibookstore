    ...
    <AdminLayout>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div className="space-y-1">
          <h1 className="font-mona text-3xl md:text-4xl font-black text-black uppercase tracking-tighter">Inventory</h1>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
          <div className="relative group flex-1 sm:flex-none">
            ...
            <input 
              ...
              className="bg-white border border-black/5 rounded-full pl-14 pr-8 py-4 font-poppins text-[11px] focus:border-black outline-none transition-all w-full sm:w-64"
            />
          </div>
          <button 
            onClick={() => navigate('/admin/products/add')}
            className="bg-black text-white px-8 py-4 rounded-full font-mona text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-neutral-800 transition-all shadow-xl shadow-black/10"
          >
            <Plus size={16} />
            New Piece
          </button>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-black/5">
                <th className="p-4 md:p-8 font-mona text-[9px] font-black uppercase tracking-[0.3em] text-black/30">Piece</th>
                <th className="p-4 md:p-8 font-mona text-[9px] font-black uppercase tracking-[0.3em] text-black/30">Category</th>
                <th className="p-4 md:p-8 font-mona text-[9px] font-black uppercase tracking-[0.3em] text-black/30">Price</th>
                <th className="p-4 md:p-8 font-mona text-[9px] font-black uppercase tracking-[0.3em] text-black/30">Stock</th>
                <th className="p-4 md:p-8 font-mona text-[9px] font-black uppercase tracking-[0.3em] text-black/30">Status</th>
                <th className="p-4 md:p-8"></th>
              </tr>
            </thead>
                  ...
                  <tr key={p.id} className="group hover:bg-black/[0.01] transition-colors">
                    <td className="p-4 md:p-8">
                      <div className="flex items-center gap-4 md:gap-6">
                        <div className="w-10 h-14 md:w-12 md:h-16 bg-[#f3f2ee] rounded overflow-hidden flex-shrink-0 border border-black/5">
                    ...
                    <td className="p-4 md:p-8 text-right">
                      <div className="flex items-center justify-end gap-1 md:gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button 
                          ...
                          className="p-2 md:p-3 text-black/20 hover:text-black transition-colors" 
                          title="Edit Piece"
                        >
                          <Edit size={16} />
                        </button>
                        <button 
                          ...
                          className="p-2 md:p-3 text-black/20 hover:text-red-500 transition-colors" 
                          title="Delete Piece"
                        >
                          <Trash2 size={16} />
                        </button>
